                  ...
                  return GridView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      return  FittedBox(child: ProductCard(
                        id: controller.specialProductList[index].id ?? 0,
                        title: controller.specialProductList[index].title ?? 'Error',
                        price: controller.specialProductList[index].price ?? '00',
                        star: controller.specialProductList[index].star.toString(),
                        image: controller.specialProductList[index].image ??
